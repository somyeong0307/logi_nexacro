...
import kr.co.seoulit.logistics.logiinfosvc.compinfo.repository.CodeRepository;
...
public class CompInfoServiceImpl implements CompInfoService {
	...
	public ArrayList<CodeTO> getCodeList() {
		...
		codeList = (ArrayList<CodeTO>)codeRepository.findAll(Sort.by(Sort.Direction.ASC, "divisionCodeNo"));
	 ...
	 @Override
	   public ArrayList<CodeDetailTO> getCodeDetailList(String CodeDetail) {
		 ...
		 ArrayList<CodeDetailTO> codeLists = null;
	      ...
	      codeLists = codeMapper.selectDetailCodeList(CodeDetail);
	   ...
	   public void addCodeInFormation(ArrayList<CodeTO>  CodeTOList) {
	    ...
	    public ArrayList<CustomerTO> getCustomerList() {
	        ...
	        return compInfoMapper.selectCustomerListByCompany();
		...
		public String getNewCustomerCode(String companyCode) {
			...
			customerList = compInfoMapper.selectCustomerListByCompany();
		...
		public CustomerInfoTO getCustomerInfo(String customerCode) {
			return compInfoMapper.selectCustomerInfo(customerCode);
		}
		
		
		@Override
		public ArrayList<DealTO> getDealList(String customerCode){
			return compInfoMapper.selectDealInfo(customerCode);
		}
		
		
		@Override
		public DealDetailTO getDealDetailInfo(String dealCode) {
			return compInfoMapper.selectDealDetailInfo(dealCode);
		}
