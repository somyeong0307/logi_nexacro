...
public interface ItemMapper {
	...
	//품목상세 조회
	public ArrayList<ItemTO> selectitemInfoList(String ableSearchConditionInfo);
	...
	//일괄저장 (저장)
	public void deletebatchSave(ItemTO bean);

	//일괄저장 (삭제)
	public void insertbatchSave(ItemTO bean);

	//일괄저장 (수정)
	public void updatebatchSave(ItemTO bean);
}
